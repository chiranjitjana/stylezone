		...
		<div class="panel-body">
            ...
            <div class="row bs-wizard" style="border-bottom:0;">
                ...
                <div class="col-xs-2 bs-wizard-step complete orderStatusDiv">
                  <div class="text-center bs-wizard-stepnum statusUpdatedDate">27-03-2018 16:18</div>
				  
                  <div class="progress">
							<div class="progress-bar"></div>
						</div>
                  <a href="#" class="bs-wizard-dot"></a>
                  <div class="bs-wizard-info text-center statusInfo">Order Request Accepted </div>
                </div>
