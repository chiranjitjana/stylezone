...
<body>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/Stylezone-ui/userlogin"><i class="fa fa-lock"></i>
										Login</a></li>
							</ul>
						</div>
					</div>
	...
	<footer id="footer">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2018 STYLEZONE Inc. All
						rights reserved.</p>
				</div>
			</div>
		</div>
